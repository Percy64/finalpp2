...
<body>
    <section class="registro-mascota">
        <form class="formulario" action="" method="post">
            ...
            <div class="recover-link" style="margin-top:10px; text-align:center;">
                <a href="<?= htmlspecialchars('../usuario/recuperar_password.php') ?>" style="color:#6b4de6; text-decoration:none;">¿Olvidaste tu contraseña?</a>
            </div>
