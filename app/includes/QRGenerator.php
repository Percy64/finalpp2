...
class QRGenerator {
    ...
    /**
     * Compatibilidad: alias del método principal
     */
    public function generateQR($id_mascota) {
        return $this->generarQRMascota($id_mascota);
    }
    ...
    public function generarQRMascota($id_mascota, $mascota_data = null) {
        try {
            ...
            $url_mascota = $this->baseUrl . '/mascota/' . $id_mascota;
    ...
    private function crearQRPlaceholder($id_mascota) {
        ...
        <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="150" y="180" text-anchor="middle" font-family="Arial" font-size="12" fill="#999">/mascota/' . $id_mascota . '</text>
        </svg>';
        ...
        return [
            ...
            'qr_path' => $filepath,
            'qr_url' => $this->baseUrl . '/' . $filepath,
            'mascota_url' => $this->baseUrl . '/mascota/' . $id_mascota,
            'filename' => $filename,
            'is_placeholder' => true
        ];
    }
